...
namespace MapleStoryMacro
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // btnMemoryScanner
            // 
            btnMemoryScanner.Alpha = 20;
            btnMemoryScanner.BackColor = Color.Transparent;
            btnMemoryScanner.Background = true;
            btnMemoryScanner.Background_WidthPen = 4F;
            btnMemoryScanner.BackgroundPen = true;
            btnMemoryScanner.ColorBackground = Color.FromArgb(130, 80, 60);
            btnMemoryScanner.ColorBackground_1 = Color.FromArgb(37, 52, 68);
            btnMemoryScanner.ColorBackground_2 = Color.FromArgb(41, 63, 86);
            btnMemoryScanner.ColorBackground_Pen = Color.FromArgb(29, 200, 238);
            btnMemoryScanner.ColorLighting = Color.FromArgb(29, 200, 238);
            btnMemoryScanner.ColorPen_1 = Color.FromArgb(37, 52, 68);
            btnMemoryScanner.ColorPen_2 = Color.FromArgb(41, 63, 86);
            btnMemoryScanner.CyberButtonStyle = ReaLTaiizor.Enum.Cyber.StateStyle.Custom;
            btnMemoryScanner.Effect_1 = true;
            btnMemoryScanner.Effect_1_ColorBackground = Color.FromArgb(29, 200, 238);
            btnMemoryScanner.Effect_1_Transparency = 25;
            ...
            btnMemoryScanner.TextButton = "@ 位置";
            btnMemoryScanner.TextRenderingHint = System.Drawing.Text.TextRenderingHint.ClearTypeGridFit;
            btnMemoryScanner.Timer_Effect_1 = 5;
            btnMemoryScanner.Timer_RGB = 300;
            btnMemoryScanner.Click += btnMemoryScanner_Click;
            // 
            // btnSaveSettings
            // 
            ...
            grpAdvanced.Size = new Size(275, 80);
        ...
        public ReaLTaiizor.Controls.CyberButton btnMemoryScanner;
